...
export class News extends Component {
  ...
  async UpdateNews() {
    ...
    let url = `https://newsapi.org/v2/top-headlines?country=${this.props.country}&category=${this.props.category}&apiKey=d0020467e557421c810e62062b7d30fc&page=1&pageSize=${this.props.pageSize}`;
    this.setState({ loading: true });
    let headers={
      'Authorization':'Bearer d0020467e557421c810e62062b7d30fc' 
    };
